In this set of videos we'll take a real case from one of our customers where we were able to improve a process that takes 5 minutes, into one second using the powers of SQL.
